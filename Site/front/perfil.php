                ...
                <div class="row">
                    ...
                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                        ...
                        <a class="nav-link" href="pages-account-settings-notifications.html"
                            ><i class="bx bx-bell me-1"></i> Métodos de pagamentos</a
                        >
                        </li>
                    </ul>
                    <div class="card mb-4">
                        ...
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            ...
                            <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                <span class="d-none d-sm-block">Fazer upload</span>
                        ...
                        <form id="formAccountSettings" method="POST" onsubmit="return false">
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="organization" class="form-label">Nome Empresa</label>
                                <input
                                type="text"
                                class="form-control"
                                id="organization"
                    ...
                    <div class="card">
                        ...
                        <div class="mb-3 col-12 mb-0">
                            ...
                            <h6 class="alert-heading fw-bold mb-1">Tem certeza que deseja excluir sua conta?</h6>
                            <p class="mb-0">Uma vez delatada sua conta, não haverá mais volta. Por favor tenha certeza!</p>
                            </div>
                        </div>
                        <form id="formAccountDeactivation" onsubmit="return false">
                            ...
                            <label class="form-check-label" for="accountActivation"
                                >Eu concordo com a desativação da minha conta</label
                            >
                            </div>
