        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">O melhor do seu negócio aqui! </h4>
              <p class="mb-4">Faça seu cadastrado abaixo!</p>

              <form id="formAuthentication" class="mb-3" action="../inc/registro.php" method="POST">
                <div class="mb-3">
